...
class LdapValidates{
    public function validateUserSyntax($user){
        $usuario = trim($user);
        if (!strlen($user)){
            throw new AuthenticationException('El Usuario es incorrecto.');
        }
    ...
    //     // Contraseña vacia.
    //     if (!strlen($pass)){
    //         throw new AuthenticationException('La Contraseña está vacia.');

    //     // Contraseña con -12 caracteres.
    //     } else if (strlen($pass) < 12){
    //         throw new AuthenticationException('La Contraseña debe tener un mínimo de 12 carácteres.');

    //     // Contraseña con +64 caracteres.
    //     } else if (strlen($pass) >64){
    //         throw new AuthenticationException('La Contraseña no puede exceder el máximo de 64 carácteres.');
